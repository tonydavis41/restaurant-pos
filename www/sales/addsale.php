...
$field_names=array('date','customer_id','sale_sub_total','sale_total_cost','paid_with','items_purchased','sold_by','comment','num_of_customers');
$field_data=array($todaysDate,$_SESSION['current_sale_customer_id'],$subtotal,$sale_total_cost,$paid_with,$temp_total_items_purchased,$_SESSION['session_user_id'],$comment,$_SESSION['num_of_customers']);
$dbf->insert($field_names,$field_data,$sales_table,false);
// Id this is an update the sale id will already be set
