...
$tableheaders=array("$lang->rowID","$lang->date","$lang->customer","$lang->numberOfCustomers","$lang->itemsPurchased","$lang->paidWith","$lang->soldBy","$lang->saleSubTotal","$lang->saleTotalCost","$lang->saleDetails");
$tablefields=array('id','date','customer_id','num_of_customers','items_purchased','paid_with','sold_by','sale_sub_total','sale_total_cost','sale_details');
