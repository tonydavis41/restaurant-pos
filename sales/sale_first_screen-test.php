...
{
	echo "DEBUG: first screen addtocard processing entered \n";
	
	if(isset($_POST['customer']))
	{
	  $_SESSION['current_sale_customer_id']=$_POST['customer'];
     echo "DEBUG: We have a customer \n";
	}
	...
	{
	  $_SESSION['current_sale_customer_id']['num_of_customers']=$_POST['num_of_customers'];
     echo "DEBUG: We have the number customer \n";
	}
	else
	{
	...
	{   
      ...
      $items_to_add=array();
		...
		{
      echo "DEBUG: Setting up items in sale array\n";
      echo "DEBUG: Got $items_to_add $quantity_to_add <br>";
      // try in 2 steps - create items_in_sale array, then session
		$_SESSION['current_sale_customer_id']['items_in_sale'][]=$items_to_add.' '.$quantity_to_add;
      if(empty($_SESSION['current_sale_customer_id']['items_in_sale'])) {
        echo "DEBUG: There was a problem creating session variable <br>";
      }
		}
      echo "DEBUG: Leaving item processing\n";
	}
   echo "DEBUG: We going to sale_ui.php \n";
